        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 space-y-4">
          ...
          <div className="flex items-start gap-2 p-4 bg-amber-50 rounded-lg border border-amber-200">
            ...
            <div className="text-sm text-amber-800">
              ...
              <p>This explanation is generated by ChatGPT and may contain errors or inaccuracies. 
              Please use it as a supplementary learning tool and verify important information from reliable sources.</p>
            </div>
          </div>
        </div>
      )}
